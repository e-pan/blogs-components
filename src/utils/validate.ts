 ...
 * 手机号校验
 * */
export const validatorUserPhone = (rule: any, value: any, callback: any) => {
...
// 银行账号校验
export const validateBank = (rule: any, value: any, callback: any) => {
  const reg = /^[\u4e00-\u9fa5]+$/
  if (reg.test(value)) {
...
// 身份证号校验
export const validatePersonNo = (rule: any, value: any, callback: any) => {
...
// 税号校验
export const validateTaxNo = (rule: any, value: any, callback: any) => {
  const reg = /^[\da-zA-Z]+$/
